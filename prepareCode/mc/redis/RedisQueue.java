...
//	}
	...
	public boolean add(E e) {
		...
		int size = size();
		Long l = getRedisDAO().lpush(namekeyBytes, eBytes);
		boolean b = false;
		if (l.intValue() > size) {
			b = true;
		}
	...
	public E poll() {
		E e = null;
		byte[] eBytes = getRedisDAO().rpop(namekeyBytes);
		if (eBytes != null) {
	...
	public E peek() {
		E e = null;
		byte[] eBytes = getRedisDAO().lindex(namekeyBytes, -1);
		if(eBytes != null){
			e = SerializeUtil.unserialize(eBytes);
		}
		return e;
