 ...
 */
public class RedisStringMapSet<T extends IVal<String>> {
	...
	public RedisStringMapSet(String prefix, Class<T> tClazz) {
		this.prefix = prefix;
		this.tClazz = tClazz;
		
		this.setKey = prefix + ":" + tClazz.getSimpleName() + "Ids";
		this.idSet = new RedisStringSet(setKey, getRedisDAO());
	...
	private static class DefaultRedisDAOHolder {
		...
		static final RedisDAO REDIS_DAO = new RedisDAO("strmapset", "0", StringUtils.isNotEmpty(masterName) ? masterName :"mymaster");
	}
	...
	public String getMapKeyPrefix(String id) {
		return "map:" + prefix;
	}
