...
import com.hzecool.fdn.ip2region.Ip2RegionFacade;
import com.hzecool.fdn.ip2region.RegionBean;
...
public class NetUtils {
	...
	public static String getUrl(String protocol, String host, int port, String context) {
		...
		if ((port == 80 && protocol.equalsIgnoreCase(PROTOCOL_HTTP)) 
				|| (port == 443 && protocol.equalsIgnoreCase(PROTOCOL_HTTPS))) {
		} else {
