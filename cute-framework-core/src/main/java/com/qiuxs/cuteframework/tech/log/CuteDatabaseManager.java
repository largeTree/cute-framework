...
public class CuteDatabaseManager extends AbstractDatabaseManager {
	...
	private CuteDatabaseManager(final String name, final int bufferSize, final ConnectionSource connectionSource, final String sqlStatement, final List<Column> columns) {
	...
	protected void connectAndStart() {
		try {
			...
			NoDbLogger.log.error("Cannot write logging event or flush buffer; JDBC manager cannot connect to the database: " + e.getMessage(), e);
			throw new AppenderLoggingException(
			        "Cannot write logging event or flush buffer; JDBC manager cannot connect to the database.",
			        e);
	...
	public static CuteDatabaseManager getJDBCDatabaseManager(final String name, final int bufferSize, final ConnectionSource connectionSource, final String tableName, final CuteColumnConfig[] columnConfigs) {
		return AbstractDatabaseManager.getManager(name, new FactoryData(bufferSize, connectionSource, tableName, columnConfigs), getFactory());
	}
	...
	private static final class FactoryData extends AbstractDatabaseManager.AbstractFactoryData {
		...
		protected FactoryData(final int bufferSize, final ConnectionSource connectionSource, final String tableName, final CuteColumnConfig[] columnConfigs) {
			super(bufferSize);
			this.connectionSource = connectionSource;
	...
	*/
	...
	private static final class Column {
		...
		private Column(final PatternLayout layout, final boolean isEventDate, final boolean isUnicode, final String type, final String name) {
			this.layout = layout;
